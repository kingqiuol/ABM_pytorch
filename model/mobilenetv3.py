...
class ResidualUnit(nn.Module):
    def __init__(self,
                 ...
                 use_se: bool = False):
        super().__init__()
        self.conv0 = ConvBNACT(in_channels=num_in_filter,
                               out_channels=num_mid_filter,
                               kernel_size=1,
                               stride=1,
                               padding=0,
        ...
        self.conv1 = ConvBNACT(in_channels=num_mid_filter,
                               out_channels=num_mid_filter,
                               kernel_size=kernel_size,
                               stride=stride,
        ...
        self.conv2 = ConvBNACT(in_channels=num_mid_filter,
...
class MobileNetV3(nn.Module):
    def __init__(self, in_channels: int = 1, model_type: str = "small"):
        super().__init__()
        ...
        if model_name == "big":
            ...
            self.cfg = [
                ...
                [5, 288, 96, True, 'hard_swish', 1],  # s=2
...
if __name__ == "__main__":
    model = MobileNetV3(in_channels=1)
    print(model)
    import time
    ...
    torch.onnx.export(model, test_data,
                      os.path.join(SAVE_ONNX_MODEL_PATH, "mbv3.onnx"))
